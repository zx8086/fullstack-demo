...
type LayoutRouteId = RouteId | "/" | "/test" | "/passing-data-refactor" | "/graphql-test-totals" | "/graphql-test-options" | "/[divisionId]" | "/some-example/shop" | "/some-example/movies" | "/modular-graphql" | null
