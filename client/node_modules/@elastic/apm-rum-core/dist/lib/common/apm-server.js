...
var ApmServer = function () {
  ...
  _proto.init = function init() {
    ...
    this._configService.observeEvent(_constants.QUEUE_FLUSH, function () {
      _this.queue.flush();
    });
  };
  ...
  _proto._makeHttpRequest = function _makeHttpRequest(method, url, _temp) {
    var _ref2 = _temp === void 0 ? {} : _temp,
        ...
        timeout = _ref2$timeout === void 0 ? _constants.HTTP_REQUEST_TIMEOUT : _ref2$timeout,
    ...
    if (!beforeSend && (0, _fetch.shouldUseFetchWithKeepAlive)(method, payload)) {
      return (0, _fetch.sendFetchRequest)(method, url, {
        keepalive: true,
        timeout: timeout,
        payload: payload,
        headers: headers,
        ...
        if (reason instanceof TypeError) {
          return (0, _xhr.sendXHR)(method, url, {
            timeout: timeout,
            payload: payload,
            headers: headers,
