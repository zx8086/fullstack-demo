 ...
 */
export declare type ExchangeSource = 'exchange';
...
export declare type ExchangeMessage = ExchangeDebugEventMessage | ExchangeConnectionInitMessage | ExchangeConnectionAckMessage | ExchangeConnectionDisconnectMessage;
/**
 * === Devtools ===
 *
 * Types for messages coming devtools
 */
export declare type DevtoolsSource = 'devtools';
...
export declare type DevtoolsMessage = DevtoolsExecuteQueryMessage | DevtoolsConnectionInitMessage | DevtoolsConnectionAckMessage;
